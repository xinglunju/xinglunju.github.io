...
# Originally from 'http://www.webweaver.nu/clipart/img/nature/ocean/dolphin.gif'
import urllib
url = 'https://www.cfa.harvard.edu/~xlu/images/dolphin.gif'
...
# Plot the 'aquarium'.
ax.text(1, 8.5, 'a poorly designed aquarium', fontsize=15,bbox={'facecolor':'yellow','alpha':0.5,'pad':10})
...
#	vel[floating,:] += random_sample(2) / 10.0
	...
	line, = ax.plot(pos[:,0]-1.4,pos[:,1]-1.0,"bo",mfc="none",mec="w",markersize=5,alpha=0)
